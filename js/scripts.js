		...
		function onSuccessRastreio(position){
			...
			$.ajax({
			type: "POST",
			url: "http://www.dbins.com.br/ferramentas/interior/rastreio_mobile_teste.php",
			dataType:"text",
		...
		function DesativarRastreio(){
			...
			$.ajax({
			type: "POST",
			url: "http://www.dbins.com.br/ferramentas/interior/rastreio_mobile_teste_email.php",
			dataType:"text",
